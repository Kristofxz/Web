...
<main>
    <div id="kapcsolat">
        <img src="kepek/logo.avif" alt= "" class="tm">

        <h1>Elérhetőség</h1>
        <div class="elemek">
        <img src="kepek/email.png" alt="" class="icons">
        <h2>E-mail:</h2>
        <p>laguna@pizza.ro</p>
        </div>
        <div class="elemek">
        <img src="kepek/telefon.png" alt="" class="icons">
        <h2>Telefonszám:</h2>
        <p>+36301234567</p>
        </div>
        <div class="elemek">
            <img src="kepek/cim.png" alt="" class="icons">
        <h2>Cím:</h2>
        <p>József Attila sgrt. 122</p>
        </div>
